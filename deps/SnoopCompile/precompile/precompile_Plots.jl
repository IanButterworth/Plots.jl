...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(contour)),Any,typeof(contour),Any,Vararg{Any,N} where N})
    ...
    Base.precompile(Tuple{typeof(expand_extrema!),Axis,Array{Int64,1}})
    ...
    Base.precompile(Tuple{typeof(iter_segments),Array{Int64,1},Array{Int64,1}})
