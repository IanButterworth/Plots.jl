...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:histogram}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(_update_subplot_periphery),Subplot{PlotlyBackend},Array{Any,1}})
    ...
    Base.precompile(Tuple{typeof(discrete_value!),Axis,Array{String,1}})
    ...
    Base.precompile(Tuple{typeof(plot),Any})
    Base.precompile(Tuple{typeof(processFontArg!),Dict{Symbol,Any},Symbol,String})
