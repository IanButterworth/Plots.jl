...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(_preprocess_barlike),DefaultsDict,Array{Float64,1},Array{Float64,1}})
    ...
    Base.precompile(Tuple{typeof(_update_subplot_periphery),Subplot{GRBackend},Array{Any,1}})
